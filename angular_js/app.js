...
.run(function($rootScope){
    ...
    $rootScope.dropdownMenuBar.push({name: 'Log out', href: 'logout', iconInitial: '/img/srcWeb/DropdownMenuBar/clauIcon.png', iconHover: '/img/srcWeb/DropdownMenuBar/clauIconHover.png', iconSelected: '/img/srcWeb/DropdownMenuBar/clauIconSelected.png', show:true});
    ...
    $rootScope.dropdownMenuBar.push({name: 'Editar panell', href: 'editPanel', iconInitial: '/img/srcWeb/DropdownMenuBar/editaPanellIcon.png', iconHover: '/img/srcWeb/DropdownMenuBar/editaPanellIconHover.png', iconSelected: '/img/srcWeb/DropdownMenuBar/editaPanellIconSelected.png', show:true});
