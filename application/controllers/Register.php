        ...
        if($user == NULL || $user == "") {
            ...
            if($userValidated === "true"){
                ...
                if ($appRunning == 'local'){
                    ...
                    //get data from user
                    $data=$this->main_model->getSingleData('SuperUser', 'ID_SU', $user);
        ...
        if($user == NULL || $user == "") {
            ...
            if (filter_var($user, FILTER_VALIDATE_EMAIL)) {
                ...
                if($emailValidated === "true"){
                    $data=$this->main_model->getSingleData('SuperUser', 'email', $email);
                    $exist=true;
                }
            }
            else{
                ...
                if($userValidated === "true"){
                    $data=$this->main_model->getSingleData('SuperUser', 'SUname', $user);
                    $exist=true;
                }
            }
